...
**WEM (Wave & E Makers)**는 성균관대학교 글로벌융합학부 컬처앤테크놀로지융합전공 소속 인터랙티브 콘텐츠 연구 학회입니다.  
인문학적 상상력과 공학적 기술력을 바탕으로, 사회·문화적 가치를 담은 기능성 게임과 인터랙티브 미디어 콘텐츠를 연구하고 제작합니다.

- **🎯 Vision**  
  인문학적 상상력과 공학적 기술력을 결합해, 사회·문화적 가치를 담은 새로운 인터랙티브 미디어 경험을 창조합니다.
...
- **[윤지형 (2기) ]** - 프론트엔드 개발 및 CMS 아키텍처 구축 및 전체 PM (Project Manager)
- **[주서진 (3기) ]** - UI/UX 디자인 및 3D 그래픽 기획
- **[장희원 (2기) 김태린 (2기) ]** - 전체 내용 작성 및 사이트 피드백 & 보완

<br>

---
*© [2026] WEM. All rights reserved.*
